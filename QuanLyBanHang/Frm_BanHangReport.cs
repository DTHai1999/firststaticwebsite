...
{
    public partial class Frm_BanHangReport : Form
    {
        public Frm_BanHangReport()
        {
        ...
        private void Frm_BanHangReport_Load(object sender, EventArgs e)
        {  
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DataSet ds = SqlHelper.ExecuteDataset(strCon, "BaoCaoBanHang",
                    DateTime.Parse(dpTuNgay.Text),
                    DateTime.Parse(dpDenNgay.Text));

                    if (ds != null && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ds.Tables[0].Columns[0].ColumnName = "Số HĐ";
                        ds.Tables[0].Columns[1].ColumnName = "Tên KH";
                        ds.Tables[0].Columns[2].ColumnName = "SĐT";
                        ds.Tables[0].Columns[3].ColumnName = "Mã SP";
                        ds.Tables[0].Columns[4].ColumnName = "Tên SP";
                        ds.Tables[0].Columns[5].ColumnName = "Loại SP";
                        ds.Tables[0].Columns[6].ColumnName = "Số lượng";
                        ds.Tables[0].Columns[7].ColumnName = "Đơn giá";
                        ds.Tables[0].Columns[8].ColumnName = "Ngày lập HĐ";
