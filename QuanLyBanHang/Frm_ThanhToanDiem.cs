...
namespace QuanLyBanHang
{
    public partial class Frm_ThanhToanDiem : Form
    {
        ...
        //string strCon = @"Data Source=DESKTOP-MT3C507\MSSQLSERVER01;Initial Catalog = HT_QLBH_BALO; Integrated Security = True";
        ...
        private void btn_thanhtoan_Click(object sender, EventArgs e)
        {
            ...
            //string str = @"Data Source=DESKTOP-MT3C507\MSSQLSERVER01;Initial Catalog = HT_QLBH_BALO; Integrated Security = True";
            string str = ConfigurationManager.ConnectionStrings["Conn"].ConnectionString;
            SqlConnection sqlCn = new SqlConnection(str);
            try
            {
                
                Tong -= TichDiem * 100000;
                TichDiem -= TichDiem;
