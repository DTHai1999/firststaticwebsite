...
namespace QuanLyBanHang
{
    public partial class Frm_SanPham : Form
    {
        ...
        private void FillData_sqlHelper()
        {
            ...
            try
            {
                string strSQL = "Select MaSP, TenSP, Gia, NCC, LoaiSP, MoTa, SoLuong, KichCo,HinhAnh From SanPham order by MaSP asc";
       ...
       private void LoadNCC()
       {
        ...
        private void dgv_danhsachsp_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                cbbdonvitinh.Text = row.Cells["KichCo"].Value.ToString();
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            string KichCo = cbbdonvitinh.Text.Trim();
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(strCon, "SPham_Update", MaSP, TenSP, GiaTien, NCC, LoaiSP, Mota, SoLuong, KichCo);
                ...
                dgv_danhsachsp["KichCo", rowIndex].Value = KichCo;
            ...
            private void cbbmasp_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (read.Read())
                {
                    ...
                    cbbdonvitinh.Text = read["KichCo"].ToString();
