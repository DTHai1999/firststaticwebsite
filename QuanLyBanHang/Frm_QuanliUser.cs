...
{
    public partial class Frm_QuanliUser : Form
    {
        string strCon = ConfigurationManager.ConnectionStrings["Conn"].ConnectionString;
        public Frm_QuanliUser()
        {
            string strCon = ConfigurationManager.ConnectionStrings["Conn"].ConnectionString;
        ...
        private void FillData_sqlHelper()
        {
            ...
            try
            {
                string strSQL = "Select UserName, NameOfUser, Phone, Status,Adress,Email From DangKyNDangNhap";
        ...
        {
            Frm_ApproveUser frm_Approve = new Frm_ApproveUser();
            frm_Approve.ReFreshDataGrid += new Frm_ApproveUser.DoEvent(RefreshGrid);
